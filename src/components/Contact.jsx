...
//template_id: template_1zjygg9
//service_id : service_c9bva38
//public_key : Eo7hlCNfJAyrbCQar

const Contact = () => {

  // creating all the hooks needed.
  ...
  const handleSubmit =(e)=>{
    ...
    emailjs.send('service_c9bva38',
    'template_1zjygg9',
    {
      from_name: form.name,
      to_name: "Mark",
      from_email: form.email,
      to_email: "testingcode54@gmail.com",
